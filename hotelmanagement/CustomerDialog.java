...
public class CustomerDialog {
    ...
    private DatePicker dateOfBirthPicker; // ADDED
    ...
    public CustomerDialog(Stage owner, Integer existingCustomerId) {
        ...
        dateOfBirthPicker.setPrefWidth(250);
        ...
        grid.add(dobLabel, 0, 3); // ADDED
        grid.add(dateOfBirthPicker, 1, 3); // ADDED
        ...
        Scene scene = new Scene(grid, 450, 400); // Increased height
    ...
    private void loadCustomerData(int customerId) {
        try (Connection conn = Database.getConnection()) {
            ...
            if (rs.next()) {
                ...
                // ADDED: Load date of birth
                java.sql.Date dob = rs.getDate("date_of_birth");
                if (dob != null) {
                    dateOfBirthPicker.setValue(dob.toLocalDate());
                }
            }
        } catch (Exception e) {
    ...
    // ADDED: Get date of birth as formatted string
    public String getDateOfBirth() {
        if (dateOfBirthPicker.getValue() != null) {
            return dateOfBirthPicker.getValue().toString(); // Returns YYYY-MM-DD format
        }
        return null;
    }
}